...
The default target is the stable package `com.dash1971.maia_chess`. Both APKs
in an upgrade test must have that package ID: Preview-to-stable installation is
not an in-place upgrade and cannot establish stable-app data compatibility.
